...
import { invitationApi } from "../../services/apiClient";
...
export default function AcceptInvitePage() {
  ...
  useEffect(() => {
    ...
    invitationApi
      ...
      .catch((err) => {
        if (!active) return;
        setLoadError(err.response?.data?.detail || "This invitation is invalid or has expired.");
        setStatus("invalid");
      });
    return () => { active = false; };
  }, [token]);
  ...
  return (
    <div
      style={{
        ...
        overflowY: "auto",
        background:
          "radial-gradient(120% 120% at 50% 0%, rgba(0,40,80,0.6) 0%, rgba(2,6,23,0.95) 70%, #020617 100%)",
      }}
    >
      <motion.div
      ...
      >
        ...
        {status === "loading" && (
          <p style={{ fontSize: 14, color: "rgba(255,255,255,0.6)", padding: "24px 0" }}>
          ...
          <>
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{ fontSize: 14, color: "rgba(255,255,255,0.6)", margin: "8px 0 0" }}>
                ...
                <span style={{ color: ACCENT, fontWeight: 600 }}>{invite?.email}</span> to access your workspace.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ marginBottom: 16 }}>
                <label htmlFor="inv-pass" style={labelStyle}>
              ...
              <div style={{ marginBottom: 26 }}>
                <label htmlFor="inv-confirm" style={labelStyle}>
