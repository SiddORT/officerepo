      ...
      <div className="card" style={{ width: "100%", maxWidth: 480, display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <form onSubmit={submit} className="portal-form-card" style={{ border: "none", padding: 0, boxShadow: "none" }}>
          <div className="portal-form-row">
            <div>
              <label className="portal-form-label portal-form-label-req">
                Code
              </label>
              <input
          ...
          <tbody>
            {loading ? (
              ...
              <tr><td colSpan={7} style={{ padding: 50, textAlign: "center" }}>
                ...
                <div className="t-muted" style={{ fontSize: 13 }}>No categories found.</div>
                <button onClick={() => setModal({ mode: "add" })} className="btn-primary" style={{ marginTop: 12 }}>Add First Category</button>
              </td></tr>
            ) : items.map((item, i) => (
              <tr key={item.id}>
                ...
                <td style={{ fontSize: 22, lineHeight: 1 }}>{item.icon || "📦"}</td>
                ...
                <td style={{ textAlign: "right" }}>
                  <div style={{ display: "flex", gap: 6, justifyContent: "flex-end" }}>
                    ...
                    <button
                      ...
                      className={item.status === "Active" ? "btn-secondary" : "btn-secondary"}
                      style={{
