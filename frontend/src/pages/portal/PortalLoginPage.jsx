      ...
      >
        ...
        <motion.div variants={stagger} initial="hidden" animate="show" style={{ transform: "translateZ(40px)" }}>
          ...
          <motion.div variants={fadeSlide} style={{ marginBottom: 30, display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              <div style={{ fontSize: 18, fontWeight: 800, letterSpacing: "-0.02em" }}>{workspaceName} Workspace</div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <motion.div variants={fadeSlide} style={{ marginBottom: 16 }}>
              ...
              <div style={{ position: "relative" }}>
                <div style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", color: focusedField === "email" ? ACCENT : "rgba(255,255,255,0.4)", transition: "color 0.2s" }}>
                ...
                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                  ...
                  placeholder="you@company.com" autoComplete="email" required style={inputStyle("email")} />
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeSlide} style={{ marginBottom: 26 }}>
              ...
              <div style={{ position: "relative" }}>
                <div style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", color: focusedField === "password" ? ACCENT : "rgba(255,255,255,0.4)", transition: "color 0.2s" }}>
                  <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <input type={showPass ? "text" : "password"} value={password}
                  ...
                  placeholder="••••••••" autoComplete="current-password" required style={inputStyle("password", true, true)} />
                <button type="button" onClick={() => setShowPass((s) => !s)}
                  aria-label={showPass ? "Hide password" : "Show password"}
                  style={{ position: "absolute", right: 12, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", color: showPass ? ACCENT : "rgba(255,255,255,0.55)", padding: 4, transition: "color 0.2s", display: "flex", alignItems: "center" }}
                  onMouseEnter={(e) => (e.currentTarget.style.color = showPass ? ACCENT : "rgba(255,255,255,0.9)")}
                  onMouseLeave={(e) => (e.currentTarget.style.color = showPass ? ACCENT : "rgba(255,255,255,0.55)")}>
                  {showPass ? (
            ...
            <motion.div variants={fadeSlide}>
              <motion.button type="submit" disabled={loading}
                ...
                style={{
                  ...
                  letterSpacing: "-0.01em", boxShadow: "0 12px 28px rgba(255,122,26,0.4)",
