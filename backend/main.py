...
from backend.app.modules.asset_management.maintenance_router import router as portal_asset_maintenance_router
...
def create_app(app_settings=settings) -> FastAPI:
    ...
    app.include_router(portal_asset_maintenance_router,  prefix=f"{prefix}/portal", tags=["portal asset maintenance"])
