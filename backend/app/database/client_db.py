...
_COLUMN_MIGRATIONS = [
    ...
    # OrgBranch — free-text notes field
    ("org_branches", "description", "TEXT"),
    ...
    ("employees",      "current_district",   "VARCHAR(100)"),
    ("employees",      "permanent_district", "VARCHAR(100)"),
    # OrgCompany — classification, compliance, extra contacts, office address
    ("org_companies", "company_type",              "VARCHAR(60)"),
    ("org_companies", "date_of_incorporation",      "DATE"),
    ("org_companies", "company_description",        "TEXT"),
    ("org_companies", "status",                      "VARCHAR(20) DEFAULT 'Active'"),
    ("org_companies", "cin_number",                  "VARCHAR(30)"),
    ("org_companies", "pan_number",                  "VARCHAR(20)"),
    ("org_companies", "tan_number",                  "VARCHAR(20)"),
    ("org_companies", "msme_registered",             "BOOLEAN DEFAULT FALSE"),
    ("org_companies", "msme_number",                 "VARCHAR(30)"),
    ("org_companies", "gst_registered",              "BOOLEAN DEFAULT FALSE"),
    ("org_companies", "gst_registration_date",       "DATE"),
    ("org_companies", "tax_identification_number",   "VARCHAR(50)"),
    ("org_companies", "primary_contact_person",      "VARCHAR(200)"),
    ("org_companies", "support_email",               "VARCHAR(254)"),
    ("org_companies", "hr_email",                    "VARCHAR(254)"),
    ("org_companies", "accounts_email",               "VARCHAR(254)"),
    ("org_companies", "office_same",                 "BOOLEAN DEFAULT TRUE"),
    ("org_companies", "off_address_line_1",          "VARCHAR(255)"),
    ("org_companies", "off_address_line_2",          "VARCHAR(255)"),
    ("org_companies", "off_city",                    "VARCHAR(100)"),
    ("org_companies", "off_district",                "VARCHAR(50)"),
