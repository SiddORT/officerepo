...
MODULE_CATALOG = [
    ...
    {"code": "hrms_exit",         "name": "Exit Management",        "description": "Employee separation lifecycle — resignation, clearance, and settlement", "route": "hrms/exit",    "icon": "log-out",   "display_order": 2009, "is_system_module": False, "parent_module_code": "hrms"},
    {"code": "hrms_ess",          "name": "Employee Self Service",  "description": "Self-service portal for employees — leave, payslips, and requests", "route": "hrms/ess",          "icon": "briefcase", "display_order": 2010, "is_system_module": False, "parent_module_code": "hrms"},
